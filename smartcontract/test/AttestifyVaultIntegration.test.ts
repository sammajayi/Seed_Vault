...
describe("AttestifyVault Integration", function () {
  async function deployVaultIntegrationFixture() {
    ...
    return { vault, mockCUSD, mockPool, mockAToken, owner, user1, user2 };
  }

  describe("Vault Deployment", function () {
    it("Should deploy with correct addresses", async function () {
      const { vault, mockCUSD, mockAToken, mockPool } = await loadFixture(deployVaultIntegrationFixture);
  ...
  describe("Deposit Flow", function () {
    it("Should handle complete deposit flow", async function () {
      const { vault, mockCUSD, mockPool, owner, user1 } = await loadFixture(deployVaultIntegrationFixture);
  ...
  describe("Withdraw Flow", function () {
    it("Should handle complete withdraw flow", async function () {
      const { vault, mockCUSD, owner, user1 } = await loadFixture(deployVaultIntegrationFixture);
